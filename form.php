...
class Form{
    ...
    private array $fields = []; //İnputların tutulacağı array
    private function __construct(   //Default oalrak boş bir action ve get methodu ile başlatılır
        private string $action = "",
        private string $method = "GET")
    { }

    //Post methodu oluşturmak için kullanılan fonksiyon
    public static function createPostForm(string $action):Form{
        $form = self::createForm($action,"POST");
        return $form;
    }

    //Get methodu oluşturmak için kullanılan fonksiyon
    ...
    //Form alanlarında oluşturulması istenilen iputları listeye ekleyen fonksiyon
    ...
    //Methodu değiştirmek için kullanılan fonksiyon
    public function setMethod(string $method):void{
        $this->method = $method;
    }

    //Oluşturulan formu ekrana html olarak basmaya yarayan fonksiyon.
